...
public class TicTacToe
{
    ...
    public static int Ai(String c[]) {
        ...
        if(checkUsedbyX(1,c)==true && checkUsedbyX(5,c)==true && checkUsed(2,c)==false && went==false) {
            y=2;
            went=true;
        }
        if(checkUsedbyX(1,c)==true && checkUsedbyX(3,c)==true && checkUsed(0,c)==false && went==false) {
            y=0;
            went=true;
        }
        if(checkUsedbyX(5,c)==true && checkUsedbyX(7,c)==true && checkUsed(8,c)==false && went==false) {
            y=8;
            went=true;
        }
        if(checkUsedbyX(7,c)==true && checkUsedbyX(3,c)==true && checkUsed(6,c)==false && went==false) {
            y=6;
            went=true;
        }
