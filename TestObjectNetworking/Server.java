...
public class Server
{
    ...
    public static void send(String message) {
        ...
        for(int i=0; i<r.size(); i++) {
            ...
            try{
                ...
                new ObjectOutputStream(o).writeObject(new Packet("Message","Server: "+message));
            }catch(IOException e) {
    ...
    public static void send(String message, Socket to) {
        try{
            ...
            DataOutputStream o = new DataOutputStream(to.getOutputStream());
            new ObjectOutputStream(o).writeObject(new Packet("Server",message));
        }catch(IOException e) {
    ...
    public static void send(Socket from, String message, String m2) {
        ...
        for(int i=0; i<r.size(); i++) {
            ...
            try{
                ...
                DataOutputStream o = new DataOutputStream(client.getOutputStream());
                new ObjectOutputStream(o).writeObject(new Packet(m2,message));
            }catch(IOException e) {
