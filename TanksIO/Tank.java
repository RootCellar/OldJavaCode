...
public class Tank
{
    ...
    public int calcEffArmor(Tank other, int thickness, int which) {
        ...
        Server.log.write("Angle: "+angle);
        Server.log.write("Thickness: "+thickness);
        Server.log.write("Effective Thickness: "+thick);
        return (int)thick;
    }
    ...
    public String spotP(Tank other, double distance) {
        ...
        if((viewRange==-1 && other.isAlive()==true) || other.getCamo()==-2) {
